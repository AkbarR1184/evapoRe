...
![](plots/map_gldas_global.png){width="8.2cm"}
![](plots/map_pet_oudin_global.png){width="8.2cm"}
...
![](plots/box_global.png){width="580"}
...
![](plots/box_subset.png){width="580"}
