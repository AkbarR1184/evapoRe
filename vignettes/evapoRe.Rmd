...
[Zenodo repository](https://doi.org/10.5281/zenodo.10011192) under the
...
"BESSv2.0", "0.05°", "", "x", "", "Monthly", "1982/01-2019/12", "[Download](https://www.environment.snu.ac.kr/bessv2)", "@li2023bessv2"
) |>
  kbl(align = 'lcccccccr') |>
...
t2m_global <- raster::brick("mswx_t2m_degC_land_197901_202308_025_monthly.nc") %>% subset_data(yrs = c(2001, 2010))
infoNC(t2m_global)
```
...
![](plots/map_gldas_global.png){width="8.2cm"}![](plots/map_pet_oudin_global.png){width="8.2cm"}
...
![](plots/map_gldas_subset.png){width="8cm"}![](plots/map_pet_oudin_subset.png){width="8cm"}
...
![](plots/map_gldas_esp.png){width="8cm"}![](plots/map_pet_oudin_esp.png){width="8cm"}
...
![](plots/heatmap_gldas_global.png){width="580"}

```{r heatmap_oudin, eval = FALSE}
plot_heatmap(pet_oudin_global_ts)
```

![](plots/heatmap_pet_oudin_global.png){width="580"}
...
![](plots/heatmap_subset.png){width="580"}
...
![](plots/heatmap_esp.png){width="580"}
...
![](plots/box_global.png){width="687"}
...
![](plots/box_subset.png){width="687"}
...
![](plots/density_global.png){width="580"}
...
![](plots/density_subset.png){width="580"}
...
![](plots/density_esp.png){width="580"}
...
![](plots/summary_gldas.png){width="637"}
...
![](plots/summary_pet_oudin.png){width="637"}
