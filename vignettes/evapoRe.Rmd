...
Let's crop our GLDAS CLSM subset to cover only Spain with the respective [shape file](https://geodata.ucdavis.edu/gadm/gadm4.1/shp/gadm41_ESP_shp.zip), and inspect its content with `infoNC`:
