...
# Plotting globals
plot_line(fldas_global_ts, var = "Actual Evapotranspiration")
plot_line(pet_oudin_global_ts, var = "Potential Evapotranspiration")

# Plotting subsets
plot_line(fldas_subset_ts, var = "Actual Evapotranspiration")
plot_line(pet_oudin_subset_ts, var = "Potential Evapotranspiration")

# Plotting cz
plot_line(fldas_cz_ts, var = "Actual Evapotranspiration")
plot_line(pet_oudin_cz_ts, var = "Potential Evapotranspiration")
...
# Plotting globals
plot_box(fldas_global_ts, var = "Actual\n Evapotranspiration")
plot_box(pet_oudin_global_ts, var = "Potential\n Evapotranspiration")

# Plotting subsets

plot_box(fldas_subset_ts, var = "Actual\n Evapotranspiration")
plot_box(pet_oudin_subset_ts, var = "Potential\n Evapotranspiration")

# Plotting cz

plot_box(fldas_cz_ts, var = "Actual\n Evapotranspiration" )
plot_box(pet_oudin_cz_ts, var = "Potential\n Evapotranspiration" )
```
...
plot_density(fldas_global_ts, var = "Actual Evapotranspiration")
plot_density(pet_oudin_global_ts, var = "Potential Evapotranspiration")

# Plotting subsets

plot_density(fldas_subset_ts, var = "Actual Evapotranspiration")
plot_density(pet_oudin_subset_ts, var = "Potential Evapotranspiration")

# Plotting cz

plot_density(fldas_cz_ts, var = "Actual Evapotranspiration")
plot_density(pet_oudin_cz_ts, var = "Potential Evapotranspiration")
```
...
```{r, eval=FALSE}
plot_summary(fldas_global_ts, var = "Actual Evapotranspiration")
