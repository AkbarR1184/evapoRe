...
```{r map_oudin_global, eval = FALSE}
plot_map(pet_oudin_global[[1]])
```

![](plots/map_oudin_global.png){width="90%"}
...
```{r map_oudin_subset, eval = FALSE}
plot_map(pet_oudin_subset[[1]])
```
![](plots/map_oudin_ceu.png){width="90%"}
...
```{r map_oudin_cz, eval = FALSE}
plot_map(pet_oudin_cz[[1]])
```
![](plots/map_oudin_cze.png){width="90%"}
...
```{r, eval=FALSE}
plot_summary(pet_oudin_global_ts, var = "Evapotranspiration")
