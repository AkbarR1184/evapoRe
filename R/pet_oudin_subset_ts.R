...
#'
#' A subset of Monthly Potential Evapotranspiration data in mm calculated by Oudin method over -10-40E, 30-45N. More details of the used method can be found \samp{https://www.sciencedirect.com/science/article/pii/S0022169404004056}.
#' 
