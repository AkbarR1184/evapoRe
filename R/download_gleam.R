...
download_gleam <- function(path = "", domain = "raw", time_res = "monthly", variable = "e", version = ""){
  old_options <- options()
  ...
  if (version == "v3-7a") {
    file_name <- paste0("gleam-", version, "_", variable, "_mm_", domain, "_198001_202112_025_", time_res, ".nc")
  } else if (version == "v4-1a") {
    file_name <- paste0("gleam-", version, "_", variable, "_mm_", domain, "_198001_202312_025_", time_res, ".nc")
  } else {
