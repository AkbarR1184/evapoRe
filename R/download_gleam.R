...
#'
#' Function for downloading GLEAM evapotranspiration data.
#'
...
download_terraclimate <- function(folder_path = ".", domain = "raw", time_res = "monthly"){
  ...
  zenodo_base <- "https://zenodo.org/deposit/7946163/files/"
  zenodo_end <- "?download=1"
  file_name <- paste0("gleam_e_mm_", domain, "_198001_202112_025_", time_res, ".nc")
