...
download_gldas_noah <- function(path = "", domain = "raw", time_res = "monthly", variable = "e", version = ""){
  old_options <- options()
  ...
  if (version == "v2-0") {
    file_name <- paste0("gldas-noah-", version, "_", variable, "_mm_", domain, "_194801_201412_025_", time_res, ".nc")
  } else if (version == "v2-1") {
    file_name <- paste0("gldas-noah-", version, "_", variable, "_mm_", domain, "_200001_202211_025_", time_res, ".nc")
  } else {
