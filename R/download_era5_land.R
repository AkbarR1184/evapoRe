...
download_era5_land <- function(path = "", domain = "raw", time_res = "monthly", variable = "e"){
  old_options <- options()
  ...
  file_name <- paste0("era5-land_", variable, "_mm_", domain, "_195001_202112_025_", time_res, ".nc")
