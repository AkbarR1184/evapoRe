...
#'
#' Function for downloading BESS evapotranspiration data.
#'
...
download_bess <- function(folder_path = ".", domain = "raw", time_res = "monthly"){
  old_options <- options()
  ...
  file_name <- paste0("bess_e_mm_", domain, "_198201_201912_025_", time_res, ".nc")
