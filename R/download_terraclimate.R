...
download_terraclimate <- function(path = "", domain = "raw", time_res = "monthly", variable = "e"){
  old_options <- options()
  ...
  file_name <- paste0("terraclimate_", variable, "_mm_", domain, "_195801_202112_025_", time_res, ".nc")
