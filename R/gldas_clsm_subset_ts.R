...
#'
#' A subset of GLDAS monthly Evapotranspiration data in mm over 2-28E, 42-58N. More details of the raw data can be found \href{https://ldas.gsfc.nasa.gov/gldas}{here}.
#'
