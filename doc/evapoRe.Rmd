...
-   *path* can be set to ".". I.e., the current working
...
![](plots/subset_ts.png){width="14cm"}
...
![](plots/heatmap_subset.png){width="14cm"}
...
![](plots/heatmap_esp.png){width="14cm"}
...
![](plots/box_global.png){width="14cm"}
...
![](plots/box_subset.png){width="14cm"}
...
![](plots/density_global.png){width="10cm"}
...
![](plots/density_subset.png){width="10cm"}
...
![](plots/density_esp.png){width="10cm"}
